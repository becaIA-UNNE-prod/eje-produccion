...
## Comando empleado
Compando empleado el martes a las 21:30 aprox para entrenar modelo UNET
```{shell}
python pad_experiments.py --train --model unet --parcel_loss --weighted_loss --root_path_coco coco_files --netcdf_path dataset/netcdf --num_epochs 3 --batch_size 4 --bands B02 B03 B04 B08 --img_size 61 61 --requires_norm --num_workers 14 --num_gpus 1 --fixed_window
```

### Visualize predictions
El modelo ya corrió. Ahora hay que ver qué resultamos obtuvimos. Por el momento, usamos
```{shell}
python visualize_predictions.py  --model unet --root_path_coco coco_files --netcdf_path dataset/netcdf --bands B02 B03 B04 B08 --img_size 61 61 --requires_norm --num_workers 14 --num_gpus 1 --fixed_window
```

Pero obtenemos como output
```
Global seed set to 16
Global seed set to 16
Error: You should provide the checkpoint to load for model testing!
```


## Comando de referencia
``` shell
python pad_experiments.py --train --model unet --parcel_loss --weighted_loss --root_path_coco coco_files --netcdf_path dataset/netcdf --num_epochs 3 --batch_size 4 --bands B02 B03 B04 B08 --img_size 61 61 --requires_norm --num_workers 28 --num_gpus 1 --fixed_window
```
